...
//
    ...
    $empleado->actualizar($id_empleado, $_POST);
    
    $historico = new Tabla("rrhh_historico");
    $hist = array('id_departamento' => $_POST['id_departamento'], 'id_empleado' => $id_empleado, 'fecha' => $_POST['fecha_inc']);
